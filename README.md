...
**238 insights · 14 topics · 25+ sources · updated weekly**
...
238+ insights across 2 domains, updated weekly as I encounter new ideas:
...
This is where the real value is today. Point Claude Code (or any AI agent) at `graph-index.yaml` — one YAML file with all 238+ nodes, descriptions, and connections.
...
│   ├── business-models.md
│   └── ...
└── insights/             # 238+ individual insight files

...
**204 insights · 14 topics · 25+ sources · updated weekly**
...
204+ insights across 2 domains, updated weekly as I encounter new ideas:
...
This is where the real value is today. Point Claude Code (or any AI agent) at `graph-index.yaml` — one YAML file with all 204+ nodes, descriptions, and connections.
...
│   ├── business-models.md
│   └── ...
└── insights/             # 204+ individual insight files
...
- **Aparna Dhinakaran ([@aparnadhinak](https://twitter.com/aparnadhinak))** — Agent harness architecture, tracing data architectures, eval/trace co-location

...
Connects to [[agents-become-the-buyer]] — when agents run the platform, they're also the purchasing decision-maker. Also connects to [[ui-moat-collapses-api-becomes-purchasing-criterion]] — AUX is the new competitive surface that replaces both UI and raw API.

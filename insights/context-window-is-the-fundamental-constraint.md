...
The practical implication: common failure patterns (kitchen-sink sessions, correction loops, over-specified CLAUDE.md, trust-then-verify gaps, infinite exploration) are all context management failures. Fixing any of them means respecting the fundamental constraint. This is why [[declarative-beats-imperative-for-agents]] matters operationally — verbose step-by-step instructions waste tokens that could carry actual working context.

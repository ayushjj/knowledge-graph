...
The standard RAG pattern treats all stored content as equally valid, but real information evolves and contradicts itself. "I love my job" (Week 1) and "I'm quitting" (Week 2) both retrieve with equal confidence because cosine similarity has no concept of recency, supersession, or conflict resolution. The agent then hallucinates a synthesis instead of recognizing that the newer fact invalidates the older one.

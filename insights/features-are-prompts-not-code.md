...
The five pillars that make this work are parity (agent can do anything UI can), granularity (tiny primitive tools), composability (new prompts = new features), emergent capability (agent does things you never designed), and self-improvement. The composability principle means you [[build-for-obsolescence-models-eat-scaffolding]] naturally — new capabilities ship without code changes.

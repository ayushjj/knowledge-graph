...
Rate-limiting is a losing strategy. Systems that fight agent access by restricting APIs are just making their product worse. The implication: as agents get better at reasoning over raw data, the elaborate schema and the rigid app on top both become scaffolding destined for obsolescence. And [[context-is-the-product-not-the-model]] takes on new meaning — the context isn't just your own data, it's every system of record your agent can clone and reason over.

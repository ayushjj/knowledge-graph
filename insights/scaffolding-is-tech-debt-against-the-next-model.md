...
Jaya Gupta gives this an investor's edge: the developer tooling that looked durable — "retrieval pipelines, output parsers, and prompt scaffolds were prosthetics for model weaknesses" — got swallowed as capability advanced, and "gains don't lift every application equally; they move the bottleneck." That bottleneck-relocation is why scaffolding decays unevenly rather than uniformly, a direct consequence of [[ai-strategy-is-a-self-rewriting-equation]], and the mechanism by which [[layer-migration-is-the-real-threat-not-competition]] — a capability gain migrates your scaffolding's function straight into the model.

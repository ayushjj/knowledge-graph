...
Boris's CLAUDE.md philosophy embodies this: "Delete your CLAUDE.md and just start fresh. The capability changes with every model. Do the minimal possible thing in order to get the model on track." This reinforces [[claude-md-should-be-routing-table-not-knowledge-base]] — minimalism isn't just a preference, it's a survival strategy against model capability turnover.
